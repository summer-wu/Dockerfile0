...
//会把func的代码转化为字符串str
形式为
function() { return (<originalFuncCode>)(); }"
phantomjs.evaluateJavaScript是nativeCode。所以不报错。

phantomjs文档在sandbox中执行（所以不报错！经测试也不能console.log） Evaluates the given function in the context of the web page. The execution is sandboxed, the web page has no access to the phantom object and it can't probe its own setting.
